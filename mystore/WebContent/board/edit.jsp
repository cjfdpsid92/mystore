...
<div class="container"  style="margin-top:5%; min-height:500px"   >
	<h3>MULTIBOARD - 글수정 </h3>
		<form action="${pageContext.request.contextPath}/edit.do?bno=${dto.bno}" method="post"  id="editForm" enctype="multipart/form-data">
		   <fieldset>
		   <legend>	UPDATE</legend>
			...
			<div class="form-group">
			  <label for="bimg"  >첨부 이미지</label>
			  <input type="text"   name="prev_img"   id="prev_img"   class="form-control"   value="${dto.bimg}"  readonly> 
